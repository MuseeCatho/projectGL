		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				...
				<s:if test="%{#session.firstname!=null}">
					<li><a href="profil.jsp"><s:property
								value="#session.firstname" /></a></li>
				</s:if>
				<s:else>
			...
			<s:else>
				...
				<button type="button" class="btn btn-primary navbar-btn"
					data-toggle="modal" data-target=".inscription">Incription</button>
...
<!-- MODAL INSCRIPTION-->
<div class="modal fade inscription" tabindex="-1" role="dialog"
			...
			<form>
				<div class="modal-body">
					...
					<div class="container-fluid">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<label for="pseudo">Pseudo*</label> <input class="form-control"
									id="pseudo" type="text" required autofocus>
							</div>
						</div>
						<div class="row">
							<div class="col-md-4">
						...
						<div class="row">
							<div class="col-md-4">
								<label for="country">Pays*</label> <input class="form-control"
						...
						<div class="row">
							<div class="col-md-4">
								<label for="job">Métier</label> <input class="form-control"
									id="job" type="text">
							</div>
						</div>
						</br>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<label for="inputEmail" class="sr-only">Email address</label> <input
					id="inputPseudo" class="form-control" placeholder="Pseudo" required

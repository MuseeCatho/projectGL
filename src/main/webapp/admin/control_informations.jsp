	...
	<s:if test="%{#session.id_userAdmin!=null}">
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<a href="get_category.action">Gestion des categories</a></br> <a
				href="get_period.action">Gestion des périodes</a> <br>
			<br>
			<div class="col-md-7 ">
				<form id="UploadForm2" action="addPhotoPresentation.action"
					method="post" enctype="multipart/form-data">

					</br> <label for="file3">Importer une image : </label> <input
						type="file" size="60" id="file3" name="upload" /> <br />
			...
			<form id="update_info" action="updateContact.action" method="post">
				...
				<div class="form-group">
					<s:iterator value="listMuseum">
						...
						<input type="text" value="<s:property value="mail" />"
				...
				<div class="form-group">
					...
					<s:iterator value="listMuseum">
						...
						<textarea class="form-control" id="presentation_f" name="presentation_f" placeholder="Entrer une description pour la page d'acceuil" rows="3"><s:property value="presentation_f" /></textarea>
					</s:iterator>
				</div>
				<div class="form-group">
					<s:iterator value="listMuseum">
						...
						<textarea class="form-control" id="presentation_e"
							name="presentation_e"
				...
				<div class="form-group">
					<s:iterator value="listMuseum">
						<label for="schedule">Horraires</label>
						<input type="text" class="form-control" id="schedule"
							name="schedule" value="<s:property value="schedule" />"
				...
				<div class="form-group">
					<s:iterator value="listMuseum">
						...
						<input type="text" value="<s:property value="access" />"
							class="form-control" id="access" name="access"
